...
//////////////////////////////////////////////////////////////////////////
// ACCS_TestTaskCharacter

ACCS_TestTaskCharacter::ACCS_TestTaskCharacter()
{
...
void ACCS_TestTaskCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
}
...
void ACCS_TestTaskCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACCS_TestTaskCharacter::Move);
...
void ACCS_TestTaskCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACCS_TestTaskCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
